...
class Game: 
    def __init__(self):
        ...
        self.attack_s_sig_right = False
        self.attack_s_sig_left = False
        ...
        self.attack_ground_pound = False
        ...
        self.s_light_left = False
        self.s_light_right = False
        self.s_sig_left = False
        self.s_sig_right = False
    ...
    def events(self):
        ...
        for event in pg.event.get():
            ...
            # s_sig_left
            if self.player.attack_timer > self.player.attack_delay_s_sig:
                if keys[pg.K_a]:
                    if event.type == pg.KEYDOWN:
                        isGrounded = pg.sprite.spritecollide(self.player, self.platforms, False)
                        # if conditions are met for the specific attack, then it does that specific attack
                        if isGrounded:
                            if event.key == pg.K_n:
                                self.attack_s_sig_left = True
                                self.s_sig_left = True
                                self.player.attack_timer = 0
                                # if event.key == pg.K_a and event.key == pg.K_SPACE:
                                #     self.player.move_control = False
            ...
            if self.player.attack_timer > self.player.attack_delay_s_sig:
                if keys[pg.K_d]:
                    if event.type == pg.KEYDOWN:
                        ...
                        if isGrounded:
                            if event.key == pg.K_n:
                                self.attack_s_sig_right = True
                                self.s_sig_right = True
                                self.player.attack_timer = 0
                                # if event.key == pg.K_a and event.key == pg.K_SPACE:
                                #     self.player.move_control = False
            ...
            if self.player.attack_timer > self.player.attack_delay_s_air:
                if keys[pg.K_a] and not keys[pg.K_w]:
                    if event.type == pg.KEYDOWN:
                        isGrounded = pg.sprite.spritecollide(self.player, self.platforms, False)
                        # if conditions are met for the specific attack, then it does that specific attack
                        if not isGrounded:
            ...
            # s_air_right
            if self.player.attack_timer > self.player.attack_delay_s_air:
                if keys[pg.K_d] and not keys[pg.K_w]:
                    if event.type == pg.KEYDOWN:
                        isGrounded = pg.sprite.spritecollide(self.player, self.platforms, False)
                        # if conditions are met for the specific attack, then it does that specific attack
                        if not isGrounded:
