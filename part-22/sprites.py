...
class Player(pg.sprite.Sprite):
    ...
    def s_sig_right(self):
        self.attack_timer = 0
        bullet = Bullet(self.rect.right, self.rect.centery, 0, 0, 50, 10, 0.2)
        bullet2 = Bullet(self.rect.right + 50, self.rect.centery, 0, 0, 50, 50, 0.2)
        self.game.all_sprites.add(bullet)
        self.game.bullets.add(bullet)
        self.game.all_sprites.add(bullet2)
        self.game.bullets.add(bullet2)
    ...
    def s_sig_left(self):
        self.attack_timer = 0
        bullet = Bullet(self.rect.left, self.rect.centery, 0, 0, 50, 10, 0.2)
        bullet2 = Bullet(self.rect.left - 50, self.rect.centery, 0, 0, 50, 50, 0.2)
        self.game.all_sprites.add(bullet)
        self.game.bullets.add(bullet)
        self.game.all_sprites.add(bullet2)
        self.game.bullets.add(bullet2)
        ...
        if keys[pg.K_s]:
            if not keys[pg.K_a] and not keys[pg.K_d]:
                if self.attack_timer > self.attack_delay_d_sig:
                    self.attack_timer = 0
                    bullet = Bullet(-450, self.rect.centery - 150, -24, 0, 900, 120, 20)
                    self.game.all_sprites.add(bullet)
                    self.game.bullets.add(bullet)
    ...
    def d_sig_right(self):
        ...
        if keys[pg.K_s]:
            if not keys[pg.K_a] and not keys[pg.K_d]:
                if self.attack_timer > self.attack_delay_d_sig:
                    self.attack_timer = 0
                    bullet = Bullet(WIDTH + 450, self.rect.centery - 150, 24, 0, 900, 120, 20)
                    self.game.all_sprites.add(bullet)
                    self.game.bullets.add(bullet)
